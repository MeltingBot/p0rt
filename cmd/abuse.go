...
// Remote API functions (to be implemented when API endpoints are added)
func showRemoteAbuseReports(serverURL, apiKey, status string, showAll bool, useJSON bool) {
	fmt.Printf("❌ Remote abuse report management not yet implemented\n")
	fmt.Printf("   Start the server locally to manage abuse reports\n")
}

func processRemoteAbuseReport(serverURL, apiKey, reportID, action string, useJSON bool) {
	fmt.Printf("❌ Remote abuse report processing not yet implemented\n")
	fmt.Printf("   Start the server locally to process abuse reports\n")
}

func showRemoteAbuseStats(serverURL, apiKey string, useJSON bool) {
	fmt.Printf("❌ Remote abuse statistics not yet implemented\n")
	fmt.Printf("   Start the server locally to view abuse statistics\n")
}