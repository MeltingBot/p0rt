...
echo ""
echo "🌐 Web Admin Interface: http://localhost:80/p0rtadmin"
echo "📊 API Endpoints:"
echo "   - http://localhost:80/api/v1/status"
echo "   - http://localhost:80/api/v1/stats"
echo "   - http://localhost:80/api/v1/reservations"
echo ""
echo "⚡ Test commands:"
echo "   curl -H 'X-API-Key: $API_KEY' http://localhost:80/api/v1/status"
echo "   curl -H 'X-API-Key: $API_KEY' http://localhost:80/api/v1/stats"
echo ""
